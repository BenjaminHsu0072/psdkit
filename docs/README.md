...
| 文档 | 说明 |
|------|------|
| [midterm-plan/](./midterm-plan/) | `.psd` 持久化中期计划与可分派子计划 |
| [manual-validation-plan/](./manual-validation-plan/) | 中期手工验收补全计划（PSDViewer + 库 API） |
| [m6-performance-baseline.md](./m6-performance-baseline.md) | M6 Release 性能 baseline 与阈值结论 |
